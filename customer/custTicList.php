                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" name="editTick" id="editTick" class="btn btn-primary btn-sm"
                                            data-bs-toggle="modal" data-bs-target="#editTickModal"><i class='fa-solid fa-pen'></i></button>
                                            <a href="custComments.php" class="btn btn-secondary btn-sm disabled-button" disabled> <i class="fa-solid fa-comments"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                <form method="#" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="viewTickSub" name="viewTickSub" disabled>
                    </div>
                    <div class="form-group">
